...
describe('LKE ACL updates', () => {
  ...
  describe('with LKE ACL account capability', () => {
    ...
    it('can enable ACL on an LKE cluster with ACL not pre-installed and edit IPs', () => {
      ...
      // currently, the query retries 4 times if receiving an error - we might change this, in which case
      // I'll update this (/is there a cleaner way to wait this query out)
